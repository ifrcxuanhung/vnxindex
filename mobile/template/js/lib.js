...
jQuery(document).ready(function() {
    ...
    ///$QRadress_2 = "800 Nguyễn Văn Linh, Quận 7";
    $QRadress_2 = "800 Nguyễn Văn Linh Tân Phú, District 7";
    //Qcode
...
// 	});
    ...
    if (jQuery("div").is("#sc_googlemap")) {
        if ($QRadress_2 != null && $QRadress_2 != "")
        {
            $googleMaps = $QRadress_2
        }
        else {
            $googleMaps = "Washington"
        } // defaultMaps
    ...
    //Profile
    if ($QRname != null && $QRname != "") {
        jQuery('#profile_data .name').slideDown()
    }
    if ($QRbirth != null && $QRbirth != "") {
        jQuery('#profile_data .birth').slideDown()
    }
    if ($QRadress != null && $QRadress != "") {
        jQuery('#profile_data .address').slideDown()
    }
    if ($QRphone != null && $QRphone != "") {
        jQuery('#profile_data .phone').slideDown()
    }
    if ($QRemail != null && $QRemail != "") {
        jQuery('#profile_data .email').slideDown()
    }
    if ($QRsite != null && $QRsite != "") {
        jQuery('#profile_data .website').slideDown()
    }
    ...
    jQuery('#mainpage_accordion_area').tabs('section > .section_body', {
        ...
        onClick: function(e, tabIndex) {
            ...
            if (tab.hasClass('resume_section_title')) {					// Resume
                ...
                // Google info
                if (QRadress != null && QRadress != "") {
                    jQuery('.add_info .address').slideDown().find('.td').html(QRadress)
                }
                if (QRphone != null && QRphone != "") {
                    jQuery('.add_info .phone').slideDown().find('.td').html(QRphone)
                }
                if (QRemail != null && QRemail != "") {
                    jQuery('.add_info .email').slideDown().find('.td').html(QRemail)
                }
                if (QRsite != null && QRsite != "") {
                    jQuery('.add_info .website').slideDown().find('.td').html(QRsite)
                }
                // Google map refresh
...
jQuery(document).ready(function() {
    if (jQuery('.portfolio_items').length !== 0) {
        ...
        jQuery('#portfolio_iso_filters li a.document').click(function() {
