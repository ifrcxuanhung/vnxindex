                ...
                <div class="content_area" id="primary">
                    <div role="main" class="site_content" id="content">
                        ...
                        <div id="mainpage_accordion_area"> 
                            <!-- LIST OF INDEXES -->
                            <section class="section resume_section even<?php echo $checkOther == false ? "" : " open"; ?>" id="resume">
                                <div class="section_header resume_section_header">
                                    <h2 class="section_title resume_section_title<?php echo $checkOther == false ? "" : " current"; ?>">
                                        <a href="#">
                                ...
                                <div class="section_body resume_section_body" <?php echo $checkOther == false ? "" : "style='display: block;'"; ?>>
                                                ...
                                                <div class="post_header resume_post_header">
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td width="25%" style="text-align: center;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['date']; ?></h4>
                                                            </td>
                                                            <td width="25%" style="text-align: right;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['last'] > 0 ? number_format($dataPerformance[0]['last'], 2, '.', ',') : 'n.a.'; ?></h4>
                                                            </td>
                                                            <td width="20%" style="text-align: right;">
                                                                <h4 class="post_title"><font style="color: <?php echo $dataPerformance[0]['var'] < 0 ? "#ff492a" : "#92dd4b"; ?>;"><?php echo $dataPerformance[0]['last'] > 0 ? number_format($dataPerformance[0]['var'], 2, '.', ',') . ' %' : 'n.a.'; ?></font></h4>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                ...
                                                <div class="post_header resume_post_header">
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td width="25%" style="text-align: center;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['mtd_date']; ?></h4>
                                                            </td>
                                                            <td width="25%" style="text-align: right;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['mtd_last'] > 0 ? number_format($dataPerformance[0]['mtd_last'], 2, '.', ',') : 'n.a.'; ?></h4>
                                                            </td>
                                                            <td width="20%" style="text-align: right;">
                                                                <h4 class="post_title"><font style="color: <?php echo $dataPerformance[0]['mtd_var'] < 0 ? "#ff492a" : "#92dd4b"; ?>;"><?php echo $dataPerformance[0]['mtd_last'] > 0 ? number_format($dataPerformance[0]['mtd_var'], 2, '.', ',') . ' %' : 'n.a.'; ?></font></h4>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                ...
                                                <div class="post_header resume_post_header">
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td width="25%" style="text-align: center;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['ytd_date']; ?></a></h4>
                                                            </td>
                                                            <td width="25%" style="text-align: right;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['ytd_last'] > 0 ? number_format($dataPerformance[0]['ytd_last'], 2, '.', ',') : 'n.a.'; ?></h4>
                                                            </td>
                                                            <td width="20%" style="text-align: right;">
                                                                <h4 class="post_title"><font style="color: <?php echo $dataPerformance[0]['ytd_var'] < 0 ? "#ff492a" : "#92dd4b"; ?>;"><?php echo $dataPerformance[0]['ytd_last'] > 0 ? number_format($dataPerformance[0]['ytd_var'], 2, '.', ',') . ' %' : 'n.a.'; ?></font></h4>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                ...
                                                <div class="post_header resume_post_header">
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td width="25%" style="text-align: center;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['52w_date']; ?></h4>
                                                            </td>
                                                            <td width="25%" style="text-align: right;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['52w_last'] > 0 ? number_format($dataPerformance[0]['52w_last'], 2, '.', ',') : 'n.a.'; ?></h4>
                                                            </td>
                                                            <td width="20%" style="text-align: right;">
                                                                <h4 class="post_title"><font style="color: <?php echo $dataPerformance[0]['52w_var'] < 0 ? "#ff492a" : "#92dd4b"; ?>;"><?php echo $dataPerformance[0]['52w_last'] > 0 ? number_format($dataPerformance[0]['52w_var'], 2, '.', ',') . ' %' : 'n.a.'; ?></font></h4>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                ...
                                                <div class="post_header resume_post_header">
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td width="25%" style="text-align: center;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['life_date']; ?></h4>
                                                            </td>
                                                            <td width="25%" style="text-align: right;">
                                                                <h4 class="post_title"><?php echo $dataPerformance[0]['life_last'] > 0 ? number_format($dataPerformance[0]['life_last'], 2, '.', ',') : 'n.a.'; ?></h4>
                                                            </td>
                                                            <td width="20%" style="text-align: right;">
                                                                <h4 class="post_title"><font style="color: <?php echo $dataPerformance[0]['life_var'] < 0 ? "#ff492a" : "#92dd4b"; ?>;"><?php echo $dataPerformance[0]['life_last'] > 0 ? number_format($dataPerformance[0]['life_var'], 2, '.', ',') . ' %' : 'n.a.'; ?></font></h4>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            ...
                                            <article class="post resume_post resume_post_1 odd" <?php echo count($dataPerformanceYear) > 0 ? "" : "style='display: none;'"; ?>>
                                                <div class="post_header resume_post_header">
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            <td width="30%"style="text-align: left;">
                                                                <h4 class="post_title"><font style="color: aqua;"><?php echo $data['trans']->getTranslate('year'); ?></font></h4>
                                                            </td>
                                                            <td width="25%" style="text-align: center;">
                                                                <h4 class="post_title"></h4>
                                                            </td>
                                                    ...
                                                    <div class="post_header resume_post_header">
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                ...
                                                                <td width="25%" style="text-align: center;">
                                                                    <h4 class="post_title"><?php echo $valuePerformanceYear['date']; ?></h4>
                                                                </td>
                                                                <td width="25%" style="text-align: right;">
                                                                    <h4 class="post_title"><?php echo $valuePerformanceYear['close'] > 0 ? number_format($valuePerformanceYear['close'], 2, '.', ',') : 'n.a.'; ?></h4>
                                                                </td>
                                                                <td width="20%" style="text-align: right;">
                                                                    <h4 class="post_title"><font style="color: <?php echo $valuePerformanceYear['perform'] < 0 ? "#ff492a" : "#92dd4b"; ?>;"><?php echo is_numeric($valuePerformanceYear['perform']) ? number_format($valuePerformanceYear['perform'], 2, '.', ',') . ' %' : 'n.a.'; ?></font></h4>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                                ...
                                                                <article class="post resume_post resume_post_1 <?php echo $countComposition == 0 ? "first" : ""; ?> even">
                                                                    <div class="post_header resume_post_header">
                                                                        <table style="width: 100%;">
                                                                            <tr>
                                                                                <td width="10%"style="text-align: left;">
                                                                                    <h4 class="post_title"><?php echo $keyComposition + 1; ?></h4>
                                                                                </td>
                                                                                <td width="10%"style="text-align: left;">
                                                                                    <h4 class="post_title"><?php echo $composition['ISIN']; ?></h4>
                                                                                </td>
                                                                                <td style="text-align: left;">
                                                                                    <h4 class="post_title"><?php echo $composition['NAME']; ?></h4>
                                                                                </td>
                                                                                <td width="10%" style="text-align: right;">
                                                                                    <h4 class="post_title"><?php echo number_format($composition['WEIGHT'], 2, '.', ','); ?> %</h4>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
