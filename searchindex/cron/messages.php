...
$messages = Array (
 ...
 "fileSize" => Array (
	0 => " <font color=red><b>File size is to large</b></font><br /> ",
	1 => " File Size is to Large<br />"
 ),
 "inDatabase" => Array (
 ...
 "starting" => Array (
  ...
  "retrieving" => Array (
	0 => " Retrieving links at %cur_time.<br />\n",
	1 => " Retrieving links at %cur_time.<br />\n"
	 ),
 "quit" => Array (
	0 => "</body></html>",
	1 => ""
...
function printRetrieving($num, $thislink, $cl) {
	global $print_results, $log_format;
	$log_msg_txt = "$num. Retrieving: <a href='$thislink' target='_blank'>$thislink</a> at " . date("H:i:s").".\n";
	$log_msg_html = "<b>$num</b>. Retrieving: <a href='$thislink' target='_blank'>$thislink</a> at " . date("H:i:s").".<br>\n";
...
function printHeader($omit, $url, $cl) {
	...
	$log_msg_html_1 = "<html><head><link rel=stylesheet href=\"main.css\" TYPE=\"text/css\"></head>\n";
	$log_msg_html_1 .= "<body style=\"font-family:Verdana, Arial; font-size:12px\">";
	
	$log_msg_html_link = "[Back to <a href=\"index.php\">Home</a>]";
