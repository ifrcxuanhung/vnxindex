...
if ($sitemap != '') { // if sitemap.xml was conform to XML version 1.0
$links = array ();
foreach($sitemap as $url) {
$links[] =($url->loc);
}
echo "<br><font color=\"green\"><b>>>> Valid sitemap.xml found here <<< </b></font>";
$links = explode(",",(implode(",",$links))); // destroy SimpleXMLElement Object and get link array
$links[] = $input_file; // add dummy so we will rember there was a valid sitemap
}
return $links;
} 
?>
