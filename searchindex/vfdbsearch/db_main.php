...
<FORM NAME="dobackup" ID="dbform" METHOD="post" ACTION="database.php">
	...
	while ($file = readdir ($dir)) { 
		if ($file != "." && $file != ".." &&  (eregi("\.sql",$file) || eregi("\.gz",$file))){
			...
			echo "<tr><td nowrap class=$bgcolor align=\"center\">$file</td>
				 ...
				 <td nowrap class=$bgcolor align=\"left\"><input type='button' id='submit' onclick=\"confirm_rest_prompt('./database.php?file=$file&del=0');\" value='Restore'> &nbsp;<input type='button' id='submit' onclick=\"confirm_del_prompt('./database.php?file=$file&del=1');\" value='Delete'></td>
				 </tr>"; 
