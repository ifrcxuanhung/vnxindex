...
function index_random() {
		...
		$result=mysql_query("select url, spider_depth, required, disallowed, can_leave_domain from ".$mysql_table_prefix."sites WHERE indexdate IS NULL ORDER BY RAND() LIMIT 1");
