...
if (isset($Submit)) {
	...
	if (!is_writable("../settings/conf.php")) {
		...
		fwrite($fhandle,"/***********************\n Sphider Pro configuration file\n***********************/");
		...
		fwrite($fhandle,"\n\n\n/*********************** \nSphider Pro settings \n***********************/");

		fwrite($fhandle, "\n\n// Mximun page size for indexing \n");

		fwrite($fhandle,"$"."max_page_size = ".$_max_page_size. ";");
...
<td colspan="2"><div class="tableSubHeading">Sphider Pro settings</div></td>
...
<td class="left1"><input name="_max_page_size" value=

"<?php print $max_page_size;?>" type="text" id=

"max_page_size" size="5" maxlength="5" /></td>

<td>Maximum page size to index kb</td>
...
<td> Enable Sphider Pro Suggest </td>
