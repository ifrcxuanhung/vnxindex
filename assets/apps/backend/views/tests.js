...
define([
    ...
    'backbone'
        ...
        var testsDetailView = Backbone.View.extend({
            el: $(".main-container"),
            initialize: function(){
            },
            events: {
                "click li.article-detail": "doShowDetailTests"
            },
            doShowDetailTests:function(event){
        ...
        return testsDetailView = new testsDetailView;
    });
