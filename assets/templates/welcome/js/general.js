    ...
    return {
            ...
            $.ajax({
                ...
                success: function($html) {
                    ...
                    $(".detail-ob-monthly").bind("click", function() {
					 ...
					 $(".detail-ob-quaterly").bind("click", function() {
                        $temp = getCookie('codeCompare');
                        $('.selectNameCompareQuater').val($temp);
                        $('.btn-compare-quater').click();
                    });
                }
            });
        },
        ...
        loadDayOb: function($code) {
            ...
            $.ajax({
                ...
                success: function($html) {
                    $('.loadDayOb').html($html);
					$(".bDiv").mCustomScrollbar({
						axis:"y",
						scrollButtons:{enable:true},
						theme:"3d",
						scrollbarPosition:"outside"
					});
					$(".mCSB_scrollTools_vertical").css('right','-5px');
				}
            });
        ...
        loadDayObFlexigrid: function($code) {
            $("#loadDayObFlexigrid").flexigrid({
                ...
                colModel: [{
                    ...
                    {
                        display: ifrc.trans('Volat1y %'),
                        name: 'Volat',
                        width: 100,
                        sortable: false,
                        align: 'right'
                    }, {
                        display: ifrc.trans('Beta1y'),
                        name: 'Beta',
                        width: 100,
                        sortable: false,
                        align: 'right'
        ...
        loadMonthOb: function($code) {
            ...
            $.ajax({
                ...
                success: function($html) {
					...
					$("#mCSB_2_scrollbar_vertical").css('left','586px');
		...
		/**********************************************************************
         * load data theo quater cua observatoire
         **********************************************************************/
        loadQuaterOb: function($code) {
            var $loading = '<div class="loading">Loading...</div>';
            $('.loadQuaterOb').html($loading);
            $.ajax({
                type: "POST",
                url: $url + 'ajax',
                data: 'act=loadQuaterOb&code=' + $code,
                success: function($html) {
                    $('.loadQuaterOb').html($html);
                    $temp = getCookie('codeCompare');
                    $('.selectNameCompareQuater').val($temp);
                }
            });
        ...
        /**********************************************************************
         * load data theo quater cua observatoire show loadDayObFlexigrid
         **********************************************************************/
        loadQuaterObFlexigrid: function($code) {
            $("#loadQuaterObFlexigrid").flexigrid({
                url: $url + 'ajax',
                dataType: 'json',
                colModel: [{
                        display: ifrc.trans('Date'),
                ...
                height: 410,
                onSuccess: function() {
                    $('#loadQuaterObFlexigrid td[abbr="Perform"]').each(function(index) {
                    ...
                    /* bold text close */
                    $('#loadQuaterObFlexigrid td[abbr="Close"]').each(function(index) {
                        $(this).css('font-weight', 'bold');
                    });
                }
            });
            ...
            function ParamData() {
                $("#loadQuaterObFlexigrid").flexOptions({
                    params: [{
                            name: 'act',
                            value: 'loadQuaterOb'
                        }, {
        ...
        showDetailAnnualPerformanceStatistics: function() {
            ...
            $.ajax({
                ...
                success: function($html) {
					...
					$(".mCSB_scrollTools_vertical").css('right','-4px');
                }
            });
        },
        ...
        loadAnnualFlexigrid: function($year) {
            $("#loadAnnualFlexigrid"+$year).flexigrid({
                ...
                height: 415,
                onSuccess: function() {
                    $('[abbr="Name"]').css('text-transform','uppercase');
                }
            });
               ...
               // title: ifrc.trans('Result'),
                ...
                onSuccess: function() {  
                 ...
                 preProcess: function(responsedata){
                     $("#total_count").html(responsedata.total +" primary indexes");
                      return responsedata;
                }
		...
		searchReviewQuater: function($search) {
            $('.observatory').html('<table id="observatoryTable"></table>');
            var selectDate = $('.box_search_obs').find('.selectDate').val();
            $("#observatoryTable").flexigrid({
                url: $url + 'ajax',
                dataType: 'json',
                colModel: [{
                        display: ifrc.trans('IDX CODE'),
                        name: 'IDX_CODE',
                        width: 170,
                        sortable: true,
                        align: 'left'
                    },{
                        display: ifrc.trans('STK CODE'),
                        name: 'STK_CODE',
                        width: 170,
                        sortable: false,
                        align: 'left'
                    },{
                        display: ifrc.trans('STK NAME'),
                        name: 'STK_NAME',
                        width: 150,
                        sortable: true,
                        align: 'left'
                    },{
                        display: ifrc.trans('STK SHARES'),
                        name: 'STK_SHARES',
                        width: 150,
                        sortable: true,
                        align: 'right',
                        ...
                        display: ifrc.trans('STK FLOAT'),
                        name: 'STK_FLOAT',
                        width: 150,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('STK CAPP'),
                        name: 'STK_CAPP',
                        width: 150,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('REFERENCE'),
                        name: 'REFERENCE',
                        width: 150,
                        sortable: true,
                        align: 'right'
        ...
        searchRpmarketmonthnull: function($search) {
            ...
            $("#observatoryTable").flexigrid({
                ...
                colModel: [{
                        ...
                        display: ifrc.trans('svolume'),
                        name: 'SVOLUME',
                        width: 90,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('sturnover'),
                        name: 'STURNOVER',
                        width: 80,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('svelo'),
                        name: 'SVELO',
                        width: 100,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('nb'),
                        name: 'NB',
                        width: 62,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('nbt'),
                        name: 'NBT',
                        width: 80,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('shares_lis'),
                        name: 'SHARES_LIS',
                        width: 50,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans(pr_cls),
                        name: 'PR_CLS',
                        width: 70,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('ssnb'),
                        name: 'SSNB',
                        width: 70,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('ssnbt'),
                        name: 'SSNBT',
                        width: 40,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('ssturnover'),
                        name: 'SSTURNOVER',
                        width: 40,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('ssvolume'),
                        name: 'SSVOLUME',
                        width: 40,
                        sortable: true,
                        align: 'right'
                    },{
                        display: ifrc.trans('ssvelo'),
                        name: 'SSVELO ',
                        width: 40,
                        sortable: true,
                        align: 'right'
            ...
            function ParamData() {
                $("#observatoryTable").flexOptions({
                    params: [{
                            name: 'act',
                            value: 'getBoxdataReportmarketmonth'
                        }, {
                            name: 'date',
                            value: $selectDate
                        }, {
        ...
        searchRpmarketmonthnull_new: function($search) {
            ...
            function ParamData() {
                $("#observatoryTable_new").flexOptions({
                    params: [{
                            name: 'act',
                            value: 'getBoxdataReportmarketmonth_new'
                        }, {
                            name: 'date',
                            value: $selectDate
                        }, {
