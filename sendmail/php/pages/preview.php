...
$newsletter_html = str_replace("sendmail.upmd.fr","upmd.fr",$newsletter_html);
...
if (isset($_REQUEST['iframe']) && !$errors) {
    ...
    <div class="main_content">
        <div class="title_head_ct">
            <h2>Newsletter:<span></span><?php echo htmlspecialchars($newsletter_data['subject']); ?></h2>
            <!-- start breadcrumb -->
            <!-- end breadcrumb -->
        </div>
        ...
        <div class="grid_9">
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i><a class="cl_fx_hrf" href="?p=create&newsletter_id=<?php echo $newsletter_id; ?>#editor">Click here to return to Newsletter Editor</a></h4>
                </div>
            </div>
        </div>
        ...
        if ($preview_email) {
            ...
            <div class="grid_9">
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i>Send mail:</h4>
                </div>
            ...
            <div class="grid_9">
                <div class="widget">
                    <div class="widget-title" style="clear: both;">
                        <h4><i class="icon-reorder"></i>Small Preview: (the one that gets emails)</h4>
                    </div>
                    <div class="widget-body">
            ...
            <div class="grid_9">
                <div class="widget">
                    <div class="widget-title" style="clear: both;">
                        <h4><i class="icon-reorder"></i>Full Preview: (the one that appears on website /  click to view online)</h4>
                    </div>
                    <div class="widget-body">
