...
<div class="main_content">
    <div class="title_head_ct">
        ...
        if (isset($_GET["p"]) && $_GET["p"] != "home") {
            ...
            echo "<li><a href='?p=campaign'>";
            echo ucwords(str_replace("_", " ", "campaign"));
        ...
        <form action="?p=campaign_open&save=true" method="post" id="create_form">
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i>Campaign Details</h4>
                </div>
                <div class="widget-body">
                    ...
                    <table class="table table-hover" style="clear: both;">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="input_wd" name="campaign_name" value="<?php echo $campaign_data['campaign_name']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="submit" name="save" style="cursor: pointer;" value="Save">
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i>Campaign Newsletters</h4>
                </div>
                <div class="widget-body">
                    <table class="table table-hover" style="clear: both;">
                        <tr>
                        ...
                        foreach ($campaign_newsletters as $newsletter_row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="icon-button edit" href="?p=open&newsletter_id=<?php echo $newsletter_row['newsletter_id']; ?>">Edit Newsletter</a> |
                                    <a class="icon-button delete" href="?p=campaign_open&campaign_id=<?php echo $campaign_id; ?>&remove_newsletter_id=<?php echo $newsletter_row['newsletter_id']; ?>" onclick="return confirm('Really remove from campaign?');" style="color:#FF0000;">Remove From Campaign</a>
                                </td>
                            </tr>
                            <?php
                        }
            ...
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i>Add Newsletter to Campaign</h4>
                </div>
                <div class="widget-body">
                    <table class="table table-hover" style="clear: both;">
                        <tr>
                            ...
                            <td>
                                <select name="add_newsletter_id" style="width: 412px;">
                                    <option value=""> - please select a newsletter - </option>
                                    <?php
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="add_send_time" size="3" value="10"> days after member joins campaign
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <input type="submit" name="add" style="cursor: pointer;" value="Add Newsletter">
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i>Campaign Customer Statuses | Current server time: <?php echo date("d M Y h:i:sa"); ?></h4>
                </div>
                <div class="widget-body">
                    <table class="table table-hover" style="clear: both;">
                        <thead>
                        ...
                        <tbody>
                            ...
                            while ($member = mysql_fetch_assoc($campaign_data['members_rs'])) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="icon-button edit" href="?p=members&edit_member_id=<?php echo $member['member_id']; ?>">Edit Member</a> |
                                        <a class="icon-button delete" href="?p=campaign_open&delete_member_id=<?php echo $member['member_id']; ?>" onclick="if(confirm('Really remove member from campaign?'))return true;else return false;">Remove from Campaign</a>
                                    </td>
                                </tr>
                                <?php
                            }
            ...
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i>Other actions | <a href="#" class="cl_fx_hrf" onclick="if(confirm('Really delete this campaign and all campaign history? Cannot undo!')){ window.location.href='?p=campaign_open&campaign_id=<?php echo $campaign_id; ?>&delete=true'; } return false;">Delete Campaign</a></h4>
                </div>
            </div>
        </form>
    </div>
