...
if (isset($_REQUEST['iframe'])) {
    ...
    if (preg_match_all('#<a href=["\'].*ext\.php\?t=lnk&id=(\d+)&#', $template_html, $matches)) {
        ...
        foreach ($matches[0] as $key => $val) {
            ...
            if (isset($processed_links[$link_id]))
                continue;
...
<div class="main_content">
    <div class="title_head_ct">
        <h2>Newsletter Link Clicks</h2>
    </div>
    <!-- start main content table -->
    <div class="grid_9">
        <div class="widget">
            <div class="widget-title">
                <h4><i class="icon-reorder"></i>Newsletter Stats | <a class="cl_fx_hrf" href="?p=open&newsletter_id=<?php echo $newsletter_id; ?>">Back to newsletter</a></h4>
            </div>
                ...
                <table class="table table-hover datatable" style="clear: both;">
                    ...
                    foreach ($send['sent_members'] as $sent_member) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                if (isset($member_data['opened'][$send_id])) {
                            ...
                            <td>
                                <?php
                                if (isset($member_data['unsubscribe'][$send_id])) {
                            ...
                            <td>
                                <?php
                                if (isset($member_data['bounces'][$send_id])) {
