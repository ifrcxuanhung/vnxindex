...
<div class="main_content">
    <div class="title_head_ct">
        <h2>Add New Member/Subscriber</h2>
        <!-- start breadcrumb -->
        <?php
        if (isset($_GET["p"]) && $_GET["p"] != "home") {
            echo "<ul class='breadcrumb'>";
            echo "<li><a href='?p=home'><i class='icon-home'></i></a><span class='divider'>&nbsp;</span></li>";
            echo "<li><a href='?p=members'>";
            echo ucwords(str_replace("_", " ", "members"));
    ...
    <form action="" method="post" id="create_form" accept-charset="UTF-8">
        <input type="hidden" name="member_id" value="new">
        <input type="hidden" name="save" value="true">
        <div class="grid_9">
            <div class="widget">
                <div class="widget-title">
                    <h4><i class="icon-reorder"></i>Add New Member</h4>
                </div>
