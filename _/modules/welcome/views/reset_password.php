...
<html xmlns = "http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php trans('change _assword'); ?></title>
                            ...
                            <div class="form-wraper fx_wd_resform" id="register-form">
                                ...
                                <form id="register" name="register" class="form"  action="" method="post">                                
                                    <div class="right_resform">                                    
                                        <div class="field">
                                            <label><font style="color: black;"><?php trans('new_password'); ?></font></label>
                                            <input type="password" name="password" id="password" value="" class="fix_wd_txt" />
                                            <div class="error"></div>
                                        </div>
                                        <div class="field half-size">
                                            <label><font style="color: black;"><?php trans('re-new_password') ?></font></label>
