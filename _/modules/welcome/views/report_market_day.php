...
<div id="content" role="main" class="observatory-content">
    <div class="intro_copn">
        <div id="tabs_global">
         <h3><?php trans("report_market_day"); ?></h3>
         ...
         <div class="box_search_obs" style="width: 60%; float: right; text-align: right;">
            <div name="search_obs" style="float: right; text-align: right;">
                ...
                <div class="search_element">     
                    <a onclick="ifrc.searchRpmarketserch()" style="cursor: pointer; display: inline-block" width="66" ><img  src="<?php echo base_url() ?>templates/images/search.png" /></a>
                    <a onclick="ifrc.resetselect2()" style="cursor: pointer; display: inline-block" width="66" ><img  src="<?php echo base_url() ?>templates/images/reset.png"/></a>
                </div> 
            </div>
    </div>
        ...
        <div id="tabs_detail_ob">
            ...
            <div  id="tabs_ob_Daily" class="searchRpmarketnull">
                <div class="observatory">
                    <script>ifrc.searchRpmarketnull();</script>
                </div>
                
            </div>
    
            <div id="tabs_ob_Daily2" class="searchRpmarketnull_new">
                 <div class="observatory_new" style="color: #fff; margin-top: 10px;">
                <script>ifrc.searchRpmarketnull_new();</script>
                 </div>
            </div>
