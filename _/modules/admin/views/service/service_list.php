    ...
    <div class="block-border">
        <form class="block-content form-table-ajax" id="" method="post" action="">
            ...
            <div style="float: right; margin-right: 20px;" class="custom-btn">
                <button onclick="$(location).attr('href','<?php echo admin_url() . 'service/add' ?>');" style="float: left; height:30px;" type="button"><?php trans('bt_add'); ?></button>
                <div style="clear: left;"></div>
            </div>

            <div class="no-margin">
                <table class="table table-service-list table-ajax" cellspacing="0" width="100%">
                    <thead>
                        <tr>
