                                        ...
                                        foreach ($value->right as $k => $v):
                                            ...
                                            <tr><td>
                                                    <div style="float:left">
                                                        ...
                                                        <input  type="hidden" name="services[<?php echo $value->services_code; ?>][<?php echo $v ?>][type]" class="datepicker" value="group">
                                                        <?php
                                                        if(isset($id)){
                                                        ?>
                                                ...
                                                <table class="table" width="100%">
                                                    ...
                                                    if (is_array($vsub->right) && count($vsub->right) > 0):
                                                        foreach ($vsub->right as $ks => $vs):
                                                            ...
                                                            <input  type="hidden" name="services[<?php echo $vsub->services_code; ?>][<?php echo $vs ?>][type]" class="datepicker" value="group">
                                                            <?php if(isset($id)){ ?>
