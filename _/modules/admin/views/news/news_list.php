                ...
                <ul id="menu" class="collapsible-list with-bg">
                    ...
                    <?php
                        foreach($data_type as $dt_k => $dt_v){
                            if($dt_v['NEW_TYPE'] == 'OTHER'){
                                unset($data_type[$dt_k]);
                            }else{
                    ?>
                        <li>
                            <input type="checkbox" name="stats-display[]" value="<?= $dt_v['NEW_TYPE'] ?>">
                            <?= $dt_v['NEW_TYPE'] ?>
                        </li>
                    <?php
                            }
    ...
    <section class="grid_8" style="display:none; width:74% !important">
        <div class="block-border">
            <form class="block-content form-table-ajax" id="" method="post" action="">
                <h1><?php trans('mn_news'); ?></h1>
                <table id="vndb_news_day_final" class="table table-news-list table-ajax" table="vndb_news_day_final" cellspacing="0" width="100%" style="display: table">
                    <thead>
                        <tr>
