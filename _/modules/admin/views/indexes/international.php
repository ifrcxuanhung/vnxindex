...
<section class="grid_12">
    <div class="block-border">
        <form class="block-content form-table-ajax" id="" method="post" action="">
            <h1><?php trans('mn_international'); ?></h1>

            <table id="idx_sample" class="table table-international-list table-ajax" table="idx_sample" cellspacing="0" width="100%" style="display: table">
                <thead>
                    <tr>
