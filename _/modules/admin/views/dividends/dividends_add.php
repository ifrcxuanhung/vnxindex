            ...
            <div class="block-content">
                ...
                <?php endif; ?>
                    <ul class="blocks-list">                    
                        <li>
                            <input type="hidden" name="notice" id="notice" value="<?php if(isset($input['notice'])) echo $input['notice']; ?>" />
                            <input type="hidden" name="confirm" id="confirm" value="<?php if(isset($input['notice'])) echo $input['confirm']; ?>" />
                            <input type="hidden" name="date_cnf" id="date_cnf" value="<?php if(isset($input['notice'])) echo $input['date_cnf']; ?>" />
