...
if (!defined('FILE_CACHE_PREFIX'))
    define('FILE_CACHE_PREFIX', 'timthumb');    // What to put at the end of all files in the cache directory so we can identify them
...
if (!defined('DEFAULT_Q'))
    define('DEFAULT_Q', 99);         // Default image quality. Allows overrid in timthumb-config.php
