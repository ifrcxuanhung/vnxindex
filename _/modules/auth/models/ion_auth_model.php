...
class Ion_auth_model extends CI_Model {
    ...
    public function hash_password_from_ifrcdata($identity, $password, $domain)
     ...
     public function login2($identity, $password, $remember = FALSE) {
        ...
        $query = $this->db->select($this->identity_column . ', username, email, id, password, active, last_login,services')
    ...
    public function update($id, array $data, $group_id) {
        ...
        $this->db->update('user_group', $data_group, array('user_id' => $user->id));
    ...
    public function login_remembered_user() {
        ...
        //get the user
        $this->trigger_events('extra_where');
        $query = $this->db->select($this->identity_column . ', id,username, email, password, active, last_login,services')
