...
<html class="no-js" dir="ltr" lang="en-US">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?php echo $data['title'] ? $data['title'] : $data['setting']['title_website']; ?></title>
        <meta content="<?php echo $data['keywords'] ? $data['keywords'] : $data['setting']['meta_keys']; ?>" name="keywords"/>
        <meta content="<?php echo $data['description'] ? $data['description'] : $data['setting']['meta_des']; ?>" name="description"/>
        <link rel="shortcut icon" href="<?php echo base_url() . 'assets/upload/Config/' . $data['setting']['logo_website']; ?>" />
        ...
        <script type="text/javascript" src="<?php echo WEBSITE_URL; ?>templates/js/html5.js"></script>
        <!--[if lt IE 9]>
            <script type="text/javascript" src="<?php echo WEBSITE_URL; ?>templates/js/html5.js"></script>
        <![endif]-->
        ...
        <div class="wrapper hfeed">
            <header id="header">
                ...
                <div class="site-navigation">
                    <div class="lang_top" style="z-index: 9999">
                        <?php
                        $data['lang'] = $data['mlang']->list_languages();
                        foreach ($data['lang'] as $value) {
                            echo '<a href="' . WEBSITE_URL . '?lang=' . $value['code_lang'] . '" ><img src="' . $value['images'] . '"';
                            if ($_SESSION['lang'] != NULL && $value['code_lang'] == $_SESSION['lang']) {
                                echo 'style="opacity:0.5" ';
                            } else if ($_SESSION['lang'] == NULL && $value['code_lang'] == $data['lang'][0]['code_lang']) {
                                echo 'style="opacity:0.5" ';
                            }
                            echo ' /></a>&nbsp';
                        }
