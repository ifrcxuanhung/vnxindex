...
$config['collections']['groups'] = 'group';
$config['collections']['login_attempts'] = 'login_attempt';
 ...
 */
/* $config['tables']['users']           = 'vfdb_users';
  $config['tables']['groups']          = 'vfdb_groups';
  $config['tables']['users_groups']    = 'vfdb_users_groups';
  $config['tables']['login_attempts']  = 'vfdb_login_attempts'; */
 ...
 */
$config['site_title'] = "vnxindex.com";   // Site Title, example.com
