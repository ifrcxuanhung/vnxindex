        ...
        var eventsListView = Backbone.View.extend({
            ...
            data: function(){
                $(document).ready(function(){
                    $(".controls-buttons").html('<div class="export-buttons" style="margin: 0; padding: 0"><ul class="controls-buttons"><li style="margin: 0; padding: 0"><a type="button" table="vndb_economics_data" class="with-tip" action="export" style="cursor: pointer">Export</a></li></ul></div>');
                });
            },
            ...
            index: function(){
                $(document).ready(function(){
                    ...
                    $(".controls-buttons").html('<div class="export-buttons" style="margin: 0; padding: 0"><ul class="controls-buttons"><li style="margin: 0; padding: 0"><a table="vndb_economics_ref" type="button" class="with-tip" action="export" style="cursor: pointer">Export</a></li></ul></div>');
                });
            },
