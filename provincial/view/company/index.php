                        ...
                        <section class="section profile_section first odd" id="profile">
                            <div class="section_header profile_section_header opened">
                                <div style="margin-left: 70px;">
                                    <input type="text" id="search-company" name="search-company" placeholder="<?php echo $data['trans']->getTranslate(CODE_CATE . '_quick_search_company'); ?>" style="position: absolute; width: 30%; margin-top: 13px; z-index: 99; display: none; font-size: 14px; text-transform: uppercase;" />
                                </div>
                                                ...
                                                <article class="post resume_post resume_post_1 <?php echo $countPerformance == 0 ? 'first' : ''; ?> <?php echo $keyPerformance % 2 == 0 ? 'even' : 'odd'; ?>">
                                                    <div class="post_header resume_post_header">
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                <td width="50%"style="text-align: left;">
                                                                    <h4 class="post_title" style="margin-left: 15px;" ><?php echo $keyPerformance == count($dataPerformance) - 1 ? $valuePerformance['eoy'] : $valuePerformance['year']; ?></h4>
                                                                </td>
                                                                <td width="25%" style="text-align: right;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left;">
                                                            <a href="javascript: void(0);" class="sort-index" sort="asc" style="text-decoration: none;">
                                                                <img src="<?php echo TEMPLATE_URL; ?>images/<?php echo $sortIndex == ' sort-asc' ? 'asc-hover' : 'asc'; ?>.png" style="position: absolute; z-index: 99; top: 16px;" />
                                                            </a>
                                                            <a href="javascript: void(0);" class="sort-index" sort="desc" style="text-decoration: none;">
                                                                <img src="<?php echo TEMPLATE_URL; ?>images/<?php echo $sortIndex == ' sort-desc' ? 'desc-hover' : 'desc'; ?>.png" style="position: absolute; z-index: 99; top: 41px;" />
                                                            </a>
                                                        ...
                                                        <td width="20%" style="text-align: left;">
                                                            <a href="javascript: void(0);" class="sort-ytd" sort="asc" style="text-decoration: none;">
                                                                <img src="<?php echo TEMPLATE_URL; ?>images/<?php echo $sortYTD == ' sort-asc' ? 'asc-hover' : 'asc'; ?>.png" style="position: absolute; z-index: 99; top: 16px;" />
                                                            </a>
                                                            <a href="javascript: void(0);" class="sort-ytd" sort="desc" style="text-decoration: none;">
                                                                <img src="<?php echo TEMPLATE_URL; ?>images/<?php echo $sortYTD == ' sort-desc' ? 'desc-hover' : 'desc'; ?>.png" style="position: absolute; z-index: 99; top: 41px;" />
                                                            </a>
                                                        ...
                                                        <td width="20%" style="text-align: left;">
                                                            <a href="javascript: void(0);" class="sort-wgt" sort="asc" style="text-decoration: none;">
                                                                <img src="<?php echo TEMPLATE_URL; ?>images/<?php echo $sortWGT == ' sort-asc' ? 'asc-hover' : 'asc'; ?>.png" style="position: absolute; z-index: 99; top: 16px;" />
                                                            </a>
                                                            <a href="javascript: void(0);" class="sort-wgt" sort="desc" style="text-decoration: none;">
                                                                <img src="<?php echo TEMPLATE_URL; ?>images/<?php echo $sortWGT == ' sort-desc' ? 'desc-hover' : 'desc'; ?>.png" style="position: absolute; z-index: 99; top: 41px;" />
                                                            </a>
                                                            <h3 class="category_title" style="text-align: right;">
                                                            ...
                                                            <table style="width: 100%;">
                                                                <tr>
                                                                    <td width="10%" style="text-align: center; padding-left: 7px;">
                                                                        <h4><?php echo ++$countMembership; ?></h4>
                                                                    <td>
                                                                    <td style="text-align: left;">
                                                                        <h4 class="post_title">
                                                                            <?php
                                                                            if (isset($valueMembership['has_link']))
                                                                            {
                                                                                ?>
                                                                                <a href="<?php echo BASE_URL ?>index/code/<?php echo $valueMembership['CODE']; ?>"><?php echo strtoupper($valueMembership['SHORTNAME']); ?></a>
                                                                                <?php
                                                                            }
                                                                            else
                                                                            {
                                                                                echo strtoupper($valueMembership['SHORTNAME']);
                                                                            }
                                                                            ?>
                                                                    ...
                                                                    <td width="20%" style="text-align: right;">
                                                                        <h4><font style="color: <?php echo number_format($valueMembership['varyear'], 2) < 0 ? '#ff492a' : '#92dd4b'; ?>"><?php echo number_format($valueMembership['varyear'], 2, '.', ',') . ' %'; ?></font></h4>
                                                                    </td>
                                                                    <td width="20%" style="text-align: right;">
                                                                        <h4><?php echo number_format($valueMembership['WEIGHT'], 2, '.', ',') . ' %'; ?></h4>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
