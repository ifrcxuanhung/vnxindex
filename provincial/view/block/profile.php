<style>
	.profile_row{display:block !important}
</style>
<section class="section profile_section first odd" id="profile"> <!--a id="blog_page_link" href="blog-category-arhive.html"><span class="icon-pencil icon"></span><span class="label">Blog</span></a-->
    <div class="section_header profile_section_header opened">
        <h2 class="section_title profile_section_title vis"><a href="#"><span class="icon icon-user"></span><span class="section_name"><?php echo $data['trans']->getTranslate(CODE_CATE . '_indexes'); ?></span></a><span class="section_icon"></span></h2>

        <div id="profile_header">
            <div id="profile_user">
                <div id="profile_photo"><img src="<?php echo TEMPLATE_URL ?>images_post/logo_ifrc12.png" alt="Intelligent Financial Research & Consulting" /></div>
            ...
            <div id="profile_data">
                ...
                <div class="profile_row website"> <span class="th"><?php echo $data['trans']->getTranslate('Website'); ?>:</span><span class="td"><a target="_blank" href="http://www.vnxindex.com">wwww.vnxindex.com</a></span> </div>
            </div>
        </div>
    </div>
    <!--<hr />-->
    <div class="section_header section_body profile_section_body">
        <div class="proile_body"><?php echo isset($data['info']['current'][0]) ? $data['info']['current'][0]['description'] . $data['info']['current'][0]['long_description']: ''; ?></div>
    </div>
</section>